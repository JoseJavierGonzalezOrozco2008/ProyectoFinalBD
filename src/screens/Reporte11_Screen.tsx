...
const ConsultarReporte11 = () => {
    ...
    const header = ['Nombre Cliente','Vendedor','FechaCompra']
    console.log(datos)
    return (
        ...
        <ScrollView style={styles.scroll}>
          ...
          <Table borderStyle={{borderWidth: 1, borderColor: 'black', justifyContent: 'center', alignContent: 'center', alignItems: 'center'}}>
            ...
            {datos.map(item =>(
                <Row key={item.FechaCompra} data={[item.Nombre,item.Vendedor,item.FechaCompra]} style={{height: 90, backgroundColor: 'white'}} textStyle={{color: 'black',textAlign: 'center'}} /> 
            ))}
